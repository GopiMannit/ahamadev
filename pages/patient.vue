              ...
              <form action="#" method="post">
                <div class="row">
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      <input type="text" class="form-control border-top-0 border-right-0 border-left-0"
                        name="expectedDate" id="expectedDate" placeholder="Expected Date"
                        @focus="switchToExpectedDateInput" v-model="data.expectedDate"
                  ...
                  <div class="col-12 col-md-6">
                    <div class="form-group">
                      <input type="text" class="form-control border-top-0 border-right-0 border-left-0"
                        name="followUpDate" id="followUpDate" placeholder="Follow Up Date"
      ...
      try {
        ...
        if (response && response.source && response.source.length > 0) {
          ...
          const formatDateTo = (dateString) => {
            if (!dateString) {
              return 'Expected Date'; // Return a placeholder or default value when the date string is empty
            }
          ...
          const formatDate = (dateString) => {
            if (!dateString) {
              return 'Follow Up Date'; // Return a placeholder or default value when the date string is empty
            }
            const [day, month, year] = dateString.split('-');
            return `${year}-${month}-${day}`;
          };
